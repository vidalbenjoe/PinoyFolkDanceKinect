...
public class GestureScriptMaglalatik : MonoBehaviour {
	...
	public string message	 = "The Maglalatik is an indigenous dance from the Philippines in which coconut shell halves that are secured onto the dancers' hands and on vests upon which are hung four or six more coconut shell halves. ";
...
// 
	...
	void Update () {
		 ...
		 if(gesturetime1 <= 0.0f) {
			...
			BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("itikitik_seventhstep");
				...
				if((BeckonManager.BeckonInstance.Gestures.IsGestureActive("itikitik_firststep",0)==true) || (BeckonManager.BeckonInstance.Gestures.IsGestureActive("itikitik_thirdstep",3)==true))  {
					...
					AddScore();
					scoreIndScript.PerfectGood();
					if((gesturetime1 < -6.0f)&&(gesturetime1 < -7.0f)){
					scoreIndScript.MissBad();MinusScore();
				...
				else if((gesturetime1 < -9.50f) && (gesturetime1 < -10.0f  )) {
		...
		//------------------------------------------------------------------------------------------>
		 ...
		 if(gesturetime2 < 0.0f){
			...
			if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("itikitik_fourthstep",3)==true)  {
				...
				else if((gesturetime2 < -7.50f) && (gesturetime2 < -9.0f  )) {
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("itikitik_fourthstep",3)==true)  {
			scoreIndScript.PerfectGood();
					AddScore();
		...
		if(gesturetime2 <= -8.0f){//after -10 millisec..  set gesturetime0 to 0 then stop deltaTime using DecreaseTime0 = false;
				DecreaseTime2 = false;
				PauseTimer2();
				scoreIndScript.HidePerfect();
		...
		//------------------------------------------------------------------------------------------>
		 ...
		 if(gesturetime4 <= 0.0f) {
			...
			else if((gesturetime4 <= -7.50f) && (gesturetime4 <= -8.0f  )) {
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("itikitik_firststep",0)==true)  {
					scoreIndScript.PerfectGood();
		...
		if(gesturetime4 <= -9.0f){//after -10 millisec..  set gesturetime0 to 0 then stop deltaTime using DecreaseTime0 = false;
				DecreaseTime4 = false;
				PauseTimer4();
				scoreIndScript.HidePerfect();
				//scoreIndScript.MissBad();
		...
		//--------------------------------------------------------===============================================
		 ...
		 if(gesturetime6 <= 0.0f) {
			...
			else if((gesturetime6<= -8.50f) && (gesturetime6 <= -9.0f  )) {
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("itikitik_thirdstep",2)==true)  {
					scoreIndScript.PerfectGood();
		...
		if(gesturetime6 <= -9.0f){//after -10 millisec..  set gesturetime0 to 0 then stop deltaTime using DecreaseTime0 = false;
				DecreaseTime6 = false;
				PauseTimer6();
			//scoreIndScript.MissBad();
				//scoreIndScript.PerfectGood();
		...
		if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("itikitik_firststep",0)==true)  {
				...
				else if((gesturetime7<= -8.50f) && (gesturetime7 <= -8.0f  )) {
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("itikitik_firststep",0)==true)  {
						scoreIndScript.PerfectGood();
				}
		...
		if(gesturetime7<= -8.0f){//after -10 millisec..  set gesturetime0 to 0 then stop deltaTime using DecreaseTime0 = false;
				DecreaseTime7 = false;
				PauseTimer7();
				scoreIndScript.HidePerfect();
				 scoreIndScript.MissBad();MinusScore();
		 ...
		 if(gesturetime8 <= 0.0f){
			...
			else if((gesturetime8<= -7.50f) && (gesturetime8 <= -8.0f  )) {
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("itikitik_firststep",0)==true)  {
				scoreIndScript.PerfectGood();
				}
		...
		if(gesturetime8<= -8.0f){//after -10 millisec..  set gesturetime0 to 0 then stop deltaTime using DecreaseTime0 = false;
				DecreaseTime8 = false;
				PauseTimer8();
				scoreIndScript.MissBad();
			}
		...
		if(gesturetime9<= -8.0f){//after -10 millisec..  set gesturetime0 to 0 then stop deltaTime using DecreaseTime0 = false;
				DecreaseTime9 = false;
				PauseTimer9();
