...
public class GestureScriptJanggay : MonoBehaviour {
	...
	//this statement will call the Initialize unction
	 ...
	 void Awake(){
		...
		BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("janggay_stepone");
		BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("janggay_steptwo");
		BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("janggay_stepthree");
		BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("janggay_stepfour");
		BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("janggay_stepfive");
		BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("janggay_stepsix");
		BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("janggay_stepseven");
...
// 
	...
	void Update () {
		...
		//------------------------------------------------------------------------------------------>
			...
			BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("janggay_firstep");//this line will enable the first gesture within the time duration
			
	
				
				if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_firstep",0)==true)  {// this line will call the gesture and match to the recorded gesture
		...
		if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_firstep",0)==true)  {
			scoreIndScript.PerfectGood();
			}
		...
		//activate the next gesture after the first gesture
		 if(gesturetime1 <= 0.0f) {
					...
					BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("janggay_firstep");
					BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("janggay_firstep");
				BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("");
				
				if((BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_firstep",0)==true) || (BeckonManager.BeckonInstance.Gestures.IsGestureActive("itikitik_thirdstep",3)==true))  {
					...
					scoreIndScript.MissBad();
					 ...
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_firstep",2)==true)  {
					scoreIndScript.PerfectGood();
					AddScore();
				
			}
					
			 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_firstep",2)==false)  {
		...
		//------------------------------------------------------------------------------------------>
		 ...
		 if(gesturetime2 < 0.0f){
			...
			BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("janggay_secondstep");
			
		
			
		
			//-------------------------------------CALL THE FIRST GESTURE----------------------
			if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_secondstep",3)==true)  {
				...
				scoreIndScript.PerfectGood();
					...
					scoreIndScript.MissBad();
					 ...
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_thirdstep",3)==true)  {
			scoreIndScript.PerfectGood();
					AddScore();
				
			}
					
				if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_thirdstep",3)==false)  {
					scoreIndScript.MissBad();
					MinusScore();
			}
		...
		//------------------------------------------------------------------------------------------>
		 ...
		 if(gesturetime3 <= 0.0f){
			...
			BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("janggay_fourthstep");
			BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("itikitik_thirdstep");
		
		
			
			//-------------------------------------CALL THE FOURTH GESTURE----------------------
			if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("itikitik_fourthstep",0)==true)  {
				...
				//after a seconds Disable the gesture
					...
					scoreIndScript.MissBad();
					 ...
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_thirdstep",0)==true)  {
					scoreIndScript.PerfectGood();
				
			}
					
				if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_thirdstep",0)==false)  {
				 		scoreIndScript.MissBad();
					MinusScore();
		...
		//------------------------------------------------------------------------------------------>
		 ...
		 if(gesturetime4 <= 0.0f) {
			...
			BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("janggay_firststep");
			BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("janggay_secondstep");
			BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("janggay_thirdstep");
			...
			AddScore();
					...
					scoreIndScript.MissBad();
					 ...
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_fifthstep",0)==true)  {
					scoreIndScript.PerfectGood();
				
			}
					
				if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_fifthstep",0)==false)  {
			scoreIndScript.MissBad();
		...
		//------------------------------------------------------------------------------------------>
			...
			BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("janggay_sixtstep");
			if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_sixthstep",3)==true)  {
				...
				scoreIndScript.PerfectGood();
					...
					scoreIndScript.MissBad();
					 ...
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_fifthstep",3)==true)  {
					scoreIndScript.PerfectGood();
				
			}
					
				if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_fifthstep",3)==false)  {
					scoreIndScript.MissBad();
		...
		//--------------------------------------------------------===============================================
		 ...
		 if(gesturetime6 <= 0.0f) {
			...
			BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("janggay_seventhstep");
		
			
			
			
			//-------------------------------------CALL THE FIRST GESTURE----------------------
			if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_seventhstep",2)==true) {
					...
					scoreIndScript.MissBad();
					 ...
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_sixstep",2)==true)  {
					scoreIndScript.PerfectGood();
				
			}
					
					if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_sixstep",2)==false)  {
				 scoreIndScript.MissBad();
					MinusScore();
		...
		if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_seventhstep",0)==true)  {
					...
					if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_seventhstep",0)==false)  {
				 	 scoreIndScript.MissBad();
		...
		if(gesturetime7<= -10.0f){//after -10 millisec..  set gesturetime0 to 0 then stop deltaTime using DecreaseTime0 = false;
		 ...
		 if(gesturetime8 <= 0.0f){
			...
			BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("janggay_firststep");
			BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("janggay_secondstep");
			BeckonManager.BeckonInstance.Gestures.DisableSDKGesture("janggay_thirdhstep");
			BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("janggay_eightstep");
			
			
			if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_eightstep",0)==true)  {
			...
			AddScore();
				...
				scoreIndScript.PerfectGood();
					...
					if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_eightstep",0)==false)  {
					 scoreIndScript.MissBad();
		...
		if(gesturetime8<= -10.0f){//after -10 millisec..  set gesturetime0 to 0 then stop deltaTime using DecreaseTime0 = false;
		 ...
		 if(gesturetime9 <= 0.0f){
			...
			BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("janggay_ninestep");
			if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_ninestep",3)==true)  {
			...
			AddScore();
				scoreIndScript.PerfectGood();
					...
					scoreIndScript.MissBad();
					 ...
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_ninestep",0)==true)  {
					scoreIndScript.PerfectGood();
				}
					
					if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_ninestep",0)==false)  {
				 		 scoreIndScript.MissBad();
		...
		if(gesturetime9<= -10.0f){//after -10 millisec..  set gesturetime0 to 0 then stop deltaTime using DecreaseTime0 = false;
		 ...
		 if(gesturetime10 <= 0.0f) {
			...
			BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("janggay_tenstep");
		
			if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_tenstep",8)==true)  {
					...
					if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_tenstep",8)==false)  {
				 	 scoreIndScript.MissBad();
		...
		if(gesturetime10 <= -10.0f){//after -10 millisec..  set gesturetime0 to 0 then stop deltaTime using DecreaseTime0 = false;
		 ...
		 if(gesturetime11 <= 0.0f) {
			...
			BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("janggay_elevenstep");
			if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_elevenstep",7)){
			...
			AddScore();
					scoreIndScript.PerfectGood();
					 ...
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_elevenstep",7)==true)  {
				scoreIndScript.PerfectGood();
				}
					
					if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_elevenstep",7)==false)  {
			 	 scoreIndScript.MissBad();
		...
		if(gesturetime11<= -10.0f){//after -10 millisec..  set gesturetime0 to 0 then stop deltaTime using DecreaseTime0 = false;
		 ...
		 if(gesturetime12 <= 0.0f) {
			...
			if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_elevenstep",2)==true)  {
			...
			AddScore();
				...
				scoreIndScript.PerfectGood();
					...
					if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_elevenstep",2)==false)  {
				 scoreIndScript.MissBad();
		...
		//////////================LAST GESTURE==============/////////
			...
			BeckonManager.BeckonInstance.Gestures.EnableSDKGesture("janggay_firststep");
		
			if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_firststep",3)) {
			...
			scoreIndScript.PerfectGood();
					 ...
					 if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_firststep",3)==true)  {
				scoreIndScript.PerfectGood();
				}
					
					if(BeckonManager.BeckonInstance.Gestures.IsGestureActive("janggay_firststep",3)==false)  {
					 scoreIndScript.MissBad();
			}
