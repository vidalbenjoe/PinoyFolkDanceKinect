...
public class PauseMenuScript : MonoBehaviour
{
	...
	public string[] credits= {
	    ...
	    "Programmer/Game Design by Benjoe Rivera Vidal",
	    "3D Modeling/Character Clothing by Mervin Reyes Pedraja",
		"Researcher/ Documentation by Nelvie Pasculado Ban-as",
	    "Copyright (c) 2013 Technological Institute of the Philippines"} ;
	...
	bool IsLegal() {
	    return !IsBrowser() || 
	    Application.absoluteURL.StartsWith("http://www.facebook.com/raizenelf22") ||
	    Application.absoluteURL.StartsWith("http://facebook.com/raizenelf22");
	...
	void ShowBackButton() {
	    if (GUI.Button(new Rect(40, Screen.height - 50, 50, 40),"Back")) {
	        currentPage = Page.Main;
	    }
	}
